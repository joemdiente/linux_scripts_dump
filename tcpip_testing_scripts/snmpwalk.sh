...
### Step 3:
snmpset -v2c -c private $SWITCHIP VTSS-IP-MIB::vtssIpConfigInterfacesIpv4Active.2 i 1 VTSS-IP-MIB::vtssIpConfigInterfacesIpv4PrefixSize.2 u 24 VTSS-IP-MIB::vtssIpConfigInterfacesIpv4EnableDhcpClient.2 i 1
